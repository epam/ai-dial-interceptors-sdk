...
|whitespace-accumulator|Generic|Buffers whitespace-only stream chunks and flushes them together when non-whitespace content arrives or a timeout is reached to reduce streaming noise.|
