...
| presidio-anonymizer      | Generic  | Anonymizes PII in the request via [Presidio](https://microsoft.github.io/presidio/anonymizer/) library, calls the upstream, deanonymizes the response. By default uses [Spacy](https://spacy.io/models/en#en_core_web_sm) as language model for PII detection.                                                                                   |
...
| PRESIDIO_NLP_MODEL_FOR_LANG_DETECTION           | en_core_web_sm                    | SpaCy model for request text language detection. Find other models [here](https://spacy.io/models).                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                           |
| PRESIDIO_NLP_MODELS_PER_LANG                    | {"en": "en_core_web_sm"}          | JSON object mapping language codes to spaCy NLP models for Presidio text processing tasks.                                                                                                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                           |
| PRESIDIO_USE_CUSTOM_TRAINED_NLP_MODEL           | false                             | Enables the use of a custom-trained NLP model in Presidio. Set it to 'true' to override the default spaCy models with your own trained model. Requires PRESIDIO_NLP_MODEL_TRAINING_DATA to be defined.                                                                                                                                                                                               |                                                                                                                                                                                                                                                           |
| PRESIDIO_NLP_MODEL_TRAINING_DATA                |                                   | List of labeled text examples in Python tuple format, with each entry structured as: <br/>("Text sentence", {"entities": [(start_idx, end_idx, "ENTITY_TYPE")]}), <br/> **Text sentence:** The input text for training.<br/> **entities:** A list of tuples identifying the start and end character indices of entities in the text, along with the entity type (e.g., "LOCATION" or "PERSON").<br/> | ("I work at EPAM", {"entities": [(10, 14, "LOCATION")]}),<br/> ("EPAM is a great company.", {"entities": [(0, 4, "LOCATION")]}),<br/> ("I work at epam", {"entities": [(10, 14, "LOCATION")]}),<br/> ("I love EPAM", {"entities": [(7, 11, "LOCATION")]}) |
| PRESIDIO_IGNORE_PII_DETECTION_FOR_UNKNOWN_LANG  | false                             | Controls the behavior of PII detection when the language is unknown or unrecognized. **- true:** Presidio will skip anonymizing PII if the language cannot be recognized, allowing processing to continue without errors. **- false:** Presidio will raise an error if the language cannot be detected.                                                                                              |                                                                                                                                                                                                                                                           |
| PRESIDIO_ALLOW_LIST                             |                                   | Comma-separated list of words to be ignored by PII anonymizer.                                                                                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                           |
| PRESIDIO_CONFIDENCE_SCORE_THRESHOLD             | 0.5                               | Numeric (0.0 to 1.0). <br/>Defines the minimum confidence score required for Presidio to detect and classify an entity as PII.                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                           |
| PRESIDIO_CUSTOM_RECOGNIZERS_CONFIG              |                                   | YAML format. Configures custom recognizers to detect specific entities in text. Find more details [here](https://microsoft.github.io/presidio/analyzer/adding_recognizers/).                                                                                                                                                                                                                         | ```- name:"EmployeeIdRecognizer" supported_entity:"EMPLOYEE_ID" patterns:  - name:"EmployeeIdRegex"  regex:"EP-\\d{6}"  score:0.95   context:  - "employee"  - "id"```                                                                                    |                                                                                                                                                                                                                                                       |
| PRESIDIO_CONTEXT_SIMILARITY_FACTOR              | 0.3                               | Numeric (0.0 to 1.0).<br/> Adjusts confidence score by it's value if context is provided. Find more details [here](https://microsoft.github.io/presidio/tutorial/06_context/).                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                           |
| PRESIDIO_MIN_SCORE_WITH_CONTEXT_SIMILARITY      | 0.35                              | Numeric (0.0 to 1.0).<br/> Minimum confidence score if context is provided. Find more details [here](https://microsoft.github.io/presidio/tutorial/06_context/).                                                                                                                                                                                                                                     |                                                                                                                                                                                                                                                           |
