...
def ignore_pii_detection(detected_language: str, supported_languages: List[str]) -> bool:
    if detected_language not in supported_languages:
        if _PRESIDIO_IGNORE_PII_DETECTION_FOR_UNKNOWN_LANG.lower() not in {"true", "false"}:
            raise ValueError(
